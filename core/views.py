...
def report_list_view(request):
    ...
    context = {
        ...
        'total_deeds': user_metrics['pdf_count'],
        'total_pages': user_metrics['pages_scanned_count'],
        'total_pdf': user_metrics['pdf_count'],          
        'total_indexing': user_metrics['indexing_count'], 
        'total_uploading': user_metrics['uploading_count'],
        'total_qc': user_metrics['qc_count'],            
        'total_metadata': user_metrics['metadata_count'],    
